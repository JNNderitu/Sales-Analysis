...
Analyzing financial data from an online learning platform offering courses in various categories. I’ll track sales by courses, instructor performance, learner engagement, and payment methods across months.
...
- step 2 : Open power query editor & in view tab under the data preview section, check "column distribution", "column quality" & "column profile" options. Also since by default, profile will open only top 1000 rows, select "column profiling based on entire dataset".
step 3 : Cleaned the data in power query.
- step 4 : Prepared visualizations.
  ##
